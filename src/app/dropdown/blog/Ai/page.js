...
const AiContent = () => {
    return (
        <div className="max-w-7xl mx-auto">
            <section className="flex w-[95%] mt-[-25vh] lg:mt-0 lg:w-full h-[80vh] lg:h-[90vh] bg-[url(/ai-1.png)] rounded-[50px] bg-contain lg:bg-cover bg-center bg-no-repeat">
                <div className="flex flex-col gap-5 self-end w-full lg:w-[60%] pb-8 pl-5">
                    <h2 className="text-3xl lg:text-6xl text-[#0268BD] font-[600]">How AI is Revolutionizing Website Development: Trends and Tools for 2025</h2>
                    <h4 className="text-[20px] font-bold">Feb 9, 2025</h4>
                    <h4 className="text-[20px] font-bold">by KSVA Tech Solutions</h4>
                </div>
            </section>
            <div className="w-[95%] lg:py-5 lg:mt-5 mx-auto">
                ...
                <div className="w-full py-5">
                    ...
                    <div className="flex gap-5 m-10">
                        <div className="relative mx-auto w-full lg:w-[50%] h-[100px]">
                ...
                <div className="w-full py-5">
                    ...
                    <div className="flex gap-10">
                        <div className="relative mx-auto w-full lg:w-[30%] h-[600px]">
                ...
                <div className="w-full py-5">
                    ...
                    <div className="relative w-full h-[50vh]">
                        ...
                        <div className="z-10 absolute right-0 top-[-80px] mx-auto w-[50%] h-[400px]">
                            <Image
                                src="/ai-10.png"
                                alt="Image"
                                layout="fill"
                        ...
                        <div className="absolute lg:right-[300px] right-[50px] top-[90px] lg:top-[80px] mx-auto lg:w-[120px] w-[100px] h-[100px] lg:h-[120px]">
                            <Image
                                src="/ai-11.png"
                                alt="Image"
                                layout="fill"
                ...
                <BlogParagraph paragraph="The question isn’t if AI will change website development—it’s how fast you can adapt to this AI-driven revolution!" className="w-full lg:w-[70%] mx-auto text-center text-[#3A8EDB]" />
            </div>
            <div className="relative mx-auto w-7xl h-[400px]">
                <Image src="/ai-12.png" alt="Amazon AI" layout="fill" className="w-full h-full transition-transform duration-300 hover:scale-105" />
            </div>
        </div>
    );
};
